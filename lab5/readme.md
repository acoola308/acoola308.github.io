...
# основное задание:
необходимо доработать лабораторную работу номер 4. Также по своему варинту, нужно заменить все вызовы и использования XMLHttpRequest на fetch.

# дополнительное задание:
реализовать скрипт, который будет пытаться делать http запрос максимум 3 раза (при неудачных попытках), и после третьего неудачного запроса выводить сообщение об ошибке
